import { Network, ListChecks, Layers, BarChart3, ArrowRight } from "lucide-react";

const processSteps = [
  {
    step: "01",
    title: "Orchestration",
    description: "Seamlessly coordinate workflows across your entire organization with intelligent automation and real-time monitoring.",
    icon: Network,
  ...
  },
  {
    ...
    description: "Efficiently manage workloads with smart queue prioritization, load balancing, and automated task distribution.",
    icon: ListChecks,
  ...
  },
  {
    ...
    description: "Connect all your systems into a unified platform with secure APIs, webhooks, and enterprise-grade integrations.",
    icon: Layers,
  ...
  },
  {
    step: "04",
    title: "Data & Metrics",
    description: "Transform raw data into actionable insights with comprehensive analytics, reporting, and performance dashboards.",
    icon: BarChart3,
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            A proven methodology that takes your operations from complexity to clarity, 
                ...
                <div key={step.step} className="relative group">
                  ...
                  <div className="bg-card/60 backdrop-blur-sm border border-border/50 rounded-2xl p-6 
                    ...
                    <div className="relative mb-6">
                      ...
                      {/* Step number badge */}
                      <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-background border-2 border-border
                    ...
                    {index < processSteps.length - 1 && (
                      <div className="hidden lg:flex absolute -right-4 top-24 w-8 h-8 rounded-full bg-card border border-border
        ...
        <div className="text-center mt-16">
          <p className="text-muted-foreground mb-4">Ready to transform your workflows?</p>
          <button className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-medium
